...
import React, { FC, ReactElement, cloneElement, useRef, useState } from 'react';
...
const Navbar: React.FC<NavbarProps> = (props) => {
	...
	return (
		<nav className={(props.className ?? "").concat(`bg-light dark:bg-dark flex justify-between items-center ${setNavbarSize()} shadow-md `)}>
			<div>
				{
					props.logo !== null &&
					<Link href="/">
