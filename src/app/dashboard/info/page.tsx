...
function InfoPage() {
  return (
    <>
      <Breadcrumb pageName="Mi Información" />

      <div className="overflow-hidden rounded-sm border border-stroke bg-dark-graye shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-13 md:h-200">
          <Image
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary py-1 px-2 text-sm font-medium text-dark-gray hover:bg-opacity-80 xsm:px-4"
            >
              <input type="file" name="cover" id="cover" className="sr-only" />
              <AiFillCamera className="text-dark-gray text-[24px]" />
              <span>Edit</span>
            </label>
          </div>
        </div>
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-10 h-1 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-fit sm:p-3">
            <div className="relative drop-shadow-2">
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <AiFillCamera className="text-dark-gray text-[24px]" />
                <input
                  type="file"
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">El gimnasio ideal</p>
            <div className="mx-1 mt-5 mb-5.5 grid max-w-md grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
